...
@export var bayrak_adi: String = ""
@export var bayrak_degeri: bool = true

@export_group("Sahne Geçişi")
@export var sahne_gecisi_yap: bool = false
@export var hedef_sahne: String = ""
@export var gecis_gecikmesi: float = 1.0

@export_group("Tetikleyici Ayarları")
@export var bir_kez_tetikle: bool = true
@export var travma_efekti_ac: bool = false
